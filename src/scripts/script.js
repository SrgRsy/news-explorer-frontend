...
if (localStorage.getItem("token")) {
    ...
    loggedInContainer.querySelector('.header__auth-button-name').textContent = 'Выход';
...
savedArticleCountHeader.textContent = `Грета, у Вас ${articleCardListCount} сохраненных статей.`;
